...
- An SMTP server, or your own mailer implementation — only required if you enable invite-only signup or required email verification
...
Apply the schema before starting your app for the first time:
