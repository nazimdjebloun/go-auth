...
- [Guides](docs/guides/) — Authentication, Sessions, Organizations, Remote Auth, Security, Admin, Audit Logs, OAuth linking, Rate Limiting — each with curl, Go, and browser-client examples
